...
export let mockForkUser: User = {
    ...
    following_url: "https://api.github.com/users/fork-user/following{/other_user}",
    gists_url: "https://api.github.com/users/fork-user/gists{/gist_id}",
    starred_url: "https://api.github.com/users/fork-user/starred{/owner}{/repo}",
    ...
    received_events_url: "https://api.github.com/users/fork-user/received_events",
    site_admin: false
};
...
export let mockEIPsRepo: Repository = {
    ...
    archive_url: "https://api.github.com/repos/ethereum/EIPs/{archive_format}{/ref}",
    assignees_url: "https://api.github.com/repos/ethereum/EIPs/assignees{/user}",
    blobs_url: "https://api.github.com/repos/ethereum/EIPs/git/blobs{/sha}",
    branches_url: "https://api.github.com/repos/ethereum/EIPs/branches{/branch}",
    collaborators_url: "https://api.github.com/repos/ethereum/EIPs/collaborators{/collaborator}",
    comments_url: "https://api.github.com/repos/ethereum/EIPs/comments{/number}",
    commits_url: "https://api.github.com/repos/ethereum/EIPs/commits{/sha}",
    compare_url: "https://api.github.com/repos/ethereum/EIPs/compare/{base}...{head}",
    ...
    git_commits_url: "https://api.github.com/repos/ethereum/EIPs/git/commits{/sha}",
    ...
    issue_comment_url: "https://api.github.com/repos/ethereum/EIPs/issues/comments{/number}",
    issue_events_url: "https://api.github.com/repos/ethereum/EIPs/issues/events{/number}",
    ...
    milestones_url: "https://api.github.com/repos/ethereum/EIPs/milestones{/number}",
    notifications_url: "https://api.github.com/repos/ethereum/EIPs/notifications{?since,all,participating}",
...
export let mockEIPsForkRepo: Repository = {
    ...
    archive_url: "https://api.github.com/repos/fork-user/EIPs/{archive_format}{/ref}",
    assignees_url: "https://api.github.com/repos/fork-user/EIPs/assignees{/user}",
    blobs_url: "https://api.github.com/repos/fork-user/EIPs/git/blobs{/sha}",
    branches_url: "https://api.github.com/repos/fork-user/EIPs/branches{/branch}",
    collaborators_url: "https://api.github.com/repos/fork-user/EIPs/collaborators{/collaborator}",
    comments_url: "https://api.github.com/repos/fork-user/EIPs/comments{/number}",
    commits_url: "https://api.github.com/repos/fork-user/EIPs/commits{/sha}",
    compare_url: "https://api.github.com/repos/fork-user/EIPs/compare/{base}...{head}",
    contents_url: "https://api.github.com/repos/fork-user/EIPs/contents/{+path}",
    contributors_url: "https://api.github.com/repos/fork-user/EIPs/contributors",
    ...
    git_commits_url: "https://api.github.com/repos/fork-user/EIPs/git/commits{/sha}",
    ...
    issue_comment_url: "https://api.github.com/repos/fork-user/EIPs/issues/comments{/number}",
    issue_events_url: "https://api.github.com/repos/fork-user/EIPs/issues/events{/number}",
    ...
    milestones_url: "https://api.github.com/repos/fork-user/EIPs/milestones{/number}",
    notifications_url: "https://api.github.com/repos/fork-user/EIPs/notifications{?since,all,participating}",
    ...
    subscription_url: "https://api.github.com/repos/fork-user/EIPs/subscription",
