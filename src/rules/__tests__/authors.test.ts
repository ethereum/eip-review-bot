...
describe("checkAuthors", () => {
    test("Should require author approval for modified EIPs", async () => {
        await expect(checkAuthors(fakeOctokit, { erc: ["a", "b", "c"] }, [{ filename: "EIPS/eip-1.md", status: "modified", previous_contents: "---\nstatus: Draft\ncategory: ERC\nauthor: Hello World (@hello), Neet (@neet), Honk, Foo <bar@example.com>\n---\nHello!", contents: "---\nstatus: Draft\ncategory: ERC\nauthor: Hello World (@hello), Neet (@neet), Honk, Foo <bar@example.com>\n---\nHello!" }])).resolves.toMatchObject([{
            name: "authors",
    ...
    test("Should not require author approval for added EIPs", async () => {
        await expect(checkAuthors(fakeOctokit, { erc: ["a", "b", "c"] }, [{ filename: "EIPS/eip-1.md", status: "added", contents: "---\nstatus: Draft\ncategory: ERC\nauthor: Hello World (@hello), Neet (@neet), Honk, Foo <bar@example.com>\n---\nHello!" }])).resolves.toMatchObject([]);
    });
    ...
    test("Should require author approval for modified ERCs", async () => {
        await expect(checkAuthors(fakeOctokit, { erc: ["a", "b", "c"] }, [{ filename: "ERCS/erc-1.md", status: "modified", previous_contents: "---\nstatus: Draft\ncategory: ERC\nauthor: Hello World (@hello), Neet (@neet), Honk, Foo <bar@example.com>\n---\nHello!", contents: "---\nstatus: Draft\ncategory: ERC\nauthor: Hello World (@hello), Neet (@neet), Honk, Foo <bar@example.com>\n---\nHello!" }])).resolves.toMatchObject([{
            name: "authors",
            reviewers: ["hello", "neet"],
            min: 1,
            pr_approval: true,
    ...
    test("Should not require author approval for added ERCs", async () => {
        await expect(checkAuthors(fakeOctokit, { erc: ["a", "b", "c"] }, [{ filename: "ERCS/erc-1.md", status: "added", contents: "---\nstatus: Draft\ncategory: ERC\nauthor: Hello World (@hello), Neet (@neet), Honk, Foo <bar@example.com>\n---\nHello!" }])).resolves.toMatchObject([]);
    });
    ...
    test("Should not require any reviewers on non-EIP file", async () => {
        await expect(checkAuthors(fakeOctokit, { erc: ["a", "b", "c"] }, [{ filename: "hello.txt", status: "modified", previous_contents: "Hello!", contents: "Hello!" }])).resolves.toMatchObject([]);
    });
});
